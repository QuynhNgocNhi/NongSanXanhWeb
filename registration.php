                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 ">
                                <div class="login-form">
                                    <form action="registration.php" method="POST" class="form" id="form-1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="Email" name="Email" type="Email" placeholder="Email VD: email@domain.com" class="form-control" required>
                                            <span class="form-message"></span>
                                        </div>
                                        <div class="form-group">

                                            <input id="UserName" name="UserName" type="text" placeholder="Tên tài khoản VD: NongSanXanh" class="form-control" required>
                                            <span class="form-message"></span>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="payment_option mb-20">
                                            <div class="custome-radio">
                                                ...
                                                <label class="form-check-label" for="exampleRadios3" data-bs-toggle="collapse" data-target="#bankTranfer" aria-controls="bankTranfer">Tôi là người mua</label>
                                            </div>
                                            <div class="custome-radio">
                                                <input class="form-check-input" required="" type="radio" name="payment_option" id="exampleRadios4" checked="" />
                                                <label class="form-check-label" for="exampleRadios4" data-bs-toggle="collapse" data-target="#checkPayment" aria-controls="checkPayment">Tôi là người bán</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="login_footer form-group mb-20">
                                            ...
                                            <a target="_blank" href="index.html"><i class="fi-rs-book-alt mr-5 text-muted"></i>Tìm hiểu</a>
                                        </div>

                                        <div class="form-group register-btn mb-30 mt-50 position-relative">
                                            <button type="submit" class="btn btn-fill-out btn-block hover-up font-weight-bold position-absolute top-100 start-50 translate-middle" id="RegisterBtn" name="register" value="Sign Up">Đăng ký</button>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="col-lg-6 advantages mt-50  mb-50">
                                ...
                                <p class="mt-20"> <b>NSX Bảo vệ người mua </b> kể từ khi nhấp đặt hàng đến khi giao hàng<br>Đăng ký hoặc đăng nhập và bạn sẽ có thể: </p>
                                <div class="mt-30">
                                    ...
                                    <p> <i class="fi-rs-star"></i>Lưu lại sản phẩm yêu thích, đánh giá, xếp hạng và hơn thế nữa.</p>
                                </div>
                                <div class="mt-30">

                                    <div class="mt-20">
                                        <h4 class="heading">QUÀ TẶNG KHI MUA LẦN ĐẦU TIÊN</h4>
                                        <p class="mt-20">Giảm 10% cho đơn hàng đầu tiên.<br>Chào mừng bạn đến với Nông sản Xanh!
                                        </p>
                                    </div>
                                </div>
                                <!-- register by others -->
