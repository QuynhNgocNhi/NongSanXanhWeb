                    ...
                    <div class="body table-responsive">
                        ...
                        <table class="table table-hover m-b-0 c_list">
                            ...
                            <tr>
                                ...
                                <th data-breakpoints="xs">Trạng thái</th>
                            ...
                            if ($_SESSION['StoreId'] == 1) {
                                ...
                                $sql = "SELECT * FROM order WHERE StoreId = '" . $_SESSION['StoreId'] . "'";
                            }
                            //todo: số trang
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <td>
                                        <div class='checkbox'>
                                            ...
                                            <label for='delete_2'>&nbsp </label>
                                        </div>
                                    </td>
                                    <td>
                                        <img src='data/Avartar_Upload/" . $row['Avatar'] . "' class='rounded-circle avatar' alt=''>
                                        <p class='c_name'>" . $row['UserName'] . "</p>
                                    </td>
                                    <td>
                                        <span><i class='zmdi m-r-10'></i>" . $row['Phone'] . "</span>
                                    </td>
                                    <td>
                                        <span ><a href='javascript:void(0);' title=''><i class='zmdi m-r-5'></i> " . $row['Email'] . "</a></span>
                                    </td>
                                    <td>
                                        <span><i class='zmdi'></i>" . $row['Address'] . "</span>
                                    </td>
                                    <td>
                                        <span><i class='zmdi'></i>" . $row['StatusActive'] . "</span>
                                    </td>
                                    <td>
                                        <a href='Product_Edit.php?ProductId=" . $row['Id'] . "'><button type='Submit' name='Edit' class='btn btn-default  btn-icon btn-success btn-icon-mini btn-round'><i class='zmdi zmdi-lock-open'></i></button></a>
                                        <a href='Product_Delete_Process.php?ProductId=" . $row['Id'] . "'><button type='Submit' name='Delete' class='btn btn-default btn-icon  btn-icon-mini btn-round'><i class='zmdi zmdi-lock'></i></button></a>
                                    </td>
                                </tr>";
                                }
                            }
