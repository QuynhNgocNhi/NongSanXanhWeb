                            ...
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    ">
                                        <ul>
                                            <li>
                                                <a href="vendors-grid.html"><i class="fi fi-rs-user mr-10"></i>Nhà cung
                                                    cấp</a>
                                            </li>
                                            <li>
                                                <a href="page-account.html"><i class="fi fi-rs-user mr-10"></i>Tài khoản
                                                    của
                                                    tôi</a>
                                            </li>
                                            <li>
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative ">
                    ...
                    <div class="logo logo-width-1 d-block d-lg-none">
                        <a href="index.html"><img src="assets/img/global/logo_home.jpg" alt="logo" /></a>
                    </div>
                                            ...
                                            <div aria-live="polite" class="slick-list draggable">
                                                <div class="slick-track" role="listbox"
                                                    ...
                                                    <a class="recent-item slick-slide slick-cloned" href="index.html"
                                                        ...
                                                        href="index.html" data-slick-index="8" aria-hidden="true"
                                                        tabindex="-1" role="option" style="width: 133px;">
                                                        <img src="home.asset/img/product/01-Fresh/01_15a.jpg"
                                                            alt="alt"></a><a class="recent-item slick-slide"
                                                        href="index.html" data-slick-index="9" aria-hidden="true"
                                                        tabindex="-1" role="option" style="width: 133px;">
                                                        <img src="home.asset/img/product/01-Fresh/01_5a.jpg"
                                                            alt="alt"></a><a class="recent-item slick-slide"
                                                        href="index.html" data-slick-index="10" aria-hidden="true"
                                                        tabindex="-1" role="option" style="width: 133px;">
                                                        <img src="home.asset/img/product/01-Fresh/01_32a.jpg"
                                                            alt="alt"></a><a
                                                        class="recent-item slick-slide slick-cloned" href="index.html"
