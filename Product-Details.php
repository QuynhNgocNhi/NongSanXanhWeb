        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> <a href="products.html">Trái cây</a> <span></span> Sầu riêng Ri6
                </div>
            </div>
        </div>
                                ...
                                <div class="row mb-50 mt-30">
                                    <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                                        <div class="detail-gallery">
                                            ...
                                            <div class="slider-nav-thumbnails">
                                                <div><img src="assets/imgs/shop/thumbnail-3.jpg" alt="product image" />
                                                </div>
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                        <div class="detail-info pr-30 pl-30">
                                            ...
                                            <h2 class="title-detail">Sầu riêng ri6</h2>
                                            ...
                                            <div class="clearfix product-price-cover">
                                                <div class="product-price primary-color float-left">
                                                    <span class="current-price text-brand">100.000</span>
                                                    <span>
                                            ...
                                            <div class="short-desc mb-30">
                                                <p class="font-lg">Sầu riêng ri6 thường được nhận dạng bởi dạng bầu dục, phần đáy hẹp, vỏ quả mỏng có màu vàng xanh, được trồng nhiều tại Đồng bằng sông Cửu Long.

                                                    Cây sầu riêng ri6 trồng khoảng 3 năm thì có trái. Khi sầu riêng chín, các gai nở bung, vỏ nứt ra rất dễ trong việc tách múi. Thông thường, sầu riêng ri6 có trọng lượng dao động từ 3 - 6kg.</p>
                                            </div>
                                            ...
                                            <div class="detail-extralink mb-50">
                                                ...
                                                <div class="product-extra-link2">
                                                    ...
                                                    <button type="submit" class="button button-add-to-cart"><i
                                                        class="fi-rs-time-fast"></i>Mua ngay</button>
                                            ...
                                            <div class="font-xs">
                                                <ul class="mr-50 float-start">
                                                  <li class="mb-5">
                                                    Loại: <span class="text-brand">Trái cây</span>
                                                  </li>
                                                  <li class="mb-5">
                                                    Ngày đăng:<span class="text-brand">10/10/2021</span>
                                                  </li>
                                                  <li>
                                            ...
                                            <div class="tab-pane fade show active" id="Description">
                                                <div class="">
                                                    ...
                                                    <p>Spluttered narrowly yikes left moth in yikes bowed this that
                                                        ...
                                                        gnashed a jellyfish and one however because.</p>
                                            ...
                                            <div class="tab-pane fade" id="Vendor-info">
                                                ...
                                                <ul class="contact-infor mb-50">
                                                    <li><img src="assets/imgs/theme/icons/icon-location.svg"
                                                            alt="" /><strong>Address: </strong> <span>5171 W Campbell
                                                            Ave undefined Kent, Utah 53127 United States</span></li>
